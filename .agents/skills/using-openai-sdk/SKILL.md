---
name: using-openai-sdk
description: 'Type-safe OpenAI Responses API usage + official docs lookup. Triggers: responses.create, AsyncOpenAI, openai docs, API reference, input, tools, web_search, extra_body. For general type workflows, load exploring-types-with-ty first.'
metadata:
  version: '1'
---
