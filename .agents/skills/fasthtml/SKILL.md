---
name: fasthtml
description: 'Build web apps with FastHTML + MonsterUI. Triggers: fasthtml, htmx, monsterui.'
metadata:
  version: '1'
---
...
- [API List](https://www.fastht.ml/docs/apilist.txt): A succinct list of all functions and methods in fasthtml.
