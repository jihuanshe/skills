---
name: spider2-price-analysis
description: 'Spider2 price data analysis with DuckDB. Triggers: price analysis, parquet query, crawler data comparison, 30d/7d trends, inventory value, cross-site price diff.'
metadata:
  version: '1'
---
