---
name: learning-from-threads
description: "Extract and consolidate knowledge from Amp threads. Triggers: ampcode.com/threads URL, T-xxx thread ID, analyze thread, learn from thread, improve skill, optimize skill, update skill from thread, what did we learn, 优化技能，改进 Skill."
metadata:
  version: '1'
---
